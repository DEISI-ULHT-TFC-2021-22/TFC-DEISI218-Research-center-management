...
enum class PublicationCategory {
    KNOWLEDGE_CONTRIBUTION, NATIONAL_MAGAZINE, INTERNACIONAL_MAGAZINE, BOOK_AUTHORSHIP, BOOK_CHAPTER, BOOK_EDITING_AND_ORGANISATION, OTHER_PUBLICATION //Edição de livros, membro de comissão,
}
